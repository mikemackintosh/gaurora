...
#include "CorsairKeyIdEnum.h"
	...
	typedef  enum 				// contains list of the LED-devices which can be connected to the DIY-device.
	{
	...
	typedef  struct 		// contains information about separate LED-device connected to the channel controlled by the DIY-device.
	{
	...
	typedef  struct 				// contains information about separate channel of the DIY-device.
	{
	...
	typedef  struct 			// contains information about channels of the DIY-devices
	{
